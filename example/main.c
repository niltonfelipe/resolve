...
main ( void )
{
  ...
  // input...
  static struct demand demand[] = { { { 0 }, "1.1.1.1", AF_INET },
                                    { { 0 }, "8.8.8.8", AF_INET },
                                    { { 0 }, "8.8.4.4", AF_INET },
                                    ...
                                    { { 0 }, "216.58.202.142", AF_INET },
                                    { { 0 }, "216.58.202.143", AF_INET },
                                    { { 0 }, "216.58.202.144", AF_INET },
                                    { { 0 }, "216.58.202.145", AF_INET },
                                    { { 0 }, "127.0.0.1", AF_INET },
                                    { { 0 }, "2001:4860:4860::8888", AF_INET6 },
                                    { { 0 }, "2001:4860:4860::8844", AF_INET6 },
                                    { { 0 }, "2001:12ff:0:7::193", AF_INET6 },
                                    { { 0 }, "2001:12ff:0:7::186", AF_INET6 },
                                    { { 0 }, "2001:12ff::8", AF_INET6 },
                                    { { 0 }, "2001:608:0:dff::2", AF_INET6 },
                                    { { 0 }, "::1", AF_INET6 } };
